 ...
 * @since 4.2.0
 */
public class BatchMessagingMessageListenerAdapter extends AbstractMethodInvokingListenerAdapter
		implements BatchMessageListener {

	public BatchMessagingMessageListenerAdapter(InvocableHandlerMethod handlerMethod,
			@Nullable KinesisOperations kinesisOperations, @Nullable String replyStream) {
		super(handlerMethod, kinesisOperations, replyStream);
	}
